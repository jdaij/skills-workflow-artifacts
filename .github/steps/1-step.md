...
<img width="600" alt="Octomatch game board" src="https://github.com/jdaij/skills-workflow-artifacts/blob/main/.github/images/octomatch.png?raw=true" />
</details>
...
| -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| <img width="450" alt="Playwright test report" src="https://github.com/jdaij/skills-workflow-artifacts/blob/main/.github/images/playwright-report.png?raw=true" /> | <img width="450" alt="Coverage report" src="https://github.com/jdaij/skills-workflow-artifacts/blob/main/.github/images/coverage-report.png?raw=true" /> |
...
1. When the workflow succeeds, you should be able to see the uploaded artifact in the workflow summary page:
    ...
    <img width="600" alt="Workflow summary page showing the uploaded test coverage report artifact" src="https://github.com/jdaij/skills-workflow-artifacts/blob/main/.github/images/tests-coverage-report-artifact.png?raw=true" />
...
1. Extract the downloaded `.zip` file and open the included `index.html` file to view the report in a more readable format.
    ...
    <img width="600" alt="Coverage report opened from the downloaded workflow artifact" src="https://github.com/jdaij/skills-workflow-artifacts/blob/main/.github/images/coverage-report.png?raw=true" />
